...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_SingleApplication_t, stringdata0) + ofs), len 
...
QT_MOC_LITERAL(18, 15), // "messageReceived"
QT_MOC_LITERAL(34, 0), // ""
QT_MOC_LITERAL(35, 7), // "message"
QT_MOC_LITERAL(43, 14) // "receiveMessage"
...
void SingleApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (SingleApplication::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SingleApplication::messageReceived)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SingleApplication::staticMetaObject = { {
    ...
    qt_meta_stringdata_SingleApplication.offsetsAndSize,
    qt_meta_data_SingleApplication,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_SingleApplication_t
, QtPrivate::TypeAndForceComplete<SingleApplication, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<const QString &, std::false_type>
